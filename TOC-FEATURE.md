...
**Possible Causes:**
- Page has fewer than minimum headings
- Container element missing or selector wrong
- Script not loaded
- JavaScript error in console

**Solutions:**
1. Check page has at least 3 headings (or your configured minimum)
2. Verify `.toc-container` element exists
3. Check Network tab - confirm script loads
4. Open DevTools Console - check for errors
5. Verify `minHeadings` configuration
...
**Solutions:**
1. Check Network tab - confirm CSS loads
2. Inspect element - see actual styles
...
- CSS override forcing `scroll-behavior: auto`
- JavaScript error
- `smoothScroll: false` configured

**Solutions:**
1. Check browser support
2. Look for CSS overrides
3. Check browser console for errors
4. Verify config: `smoothScroll: true`
...
**Solutions:**
1. Verify `highlightActiveSection: true`
2. Check console for JavaScript errors
3. Ensure headings have IDs
4. Check Network tab - script loads
...
- CSS media queries not triggered
- Touch events not handled
- Font size too large

**Solutions:**
1. Verify viewport meta tag present
2. Test responsive view in DevTools
3. Check CSS media queries (768px breakpoint)
...
- **Documentation**: See `TOC-README.md` for quick reference
- **Examples**: Check `TOC-EXAMPLE.html` for working examples
